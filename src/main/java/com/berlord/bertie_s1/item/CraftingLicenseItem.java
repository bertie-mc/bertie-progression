 ...
 * (see {@link com.berlord.bertie_s1.gate.CraftingGateHandler}). Replaces the Licensed Crafting
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (Boolean.TRUE.equals(player.getData(ModAttachments.CRAFTING_LICENSED.get()))) {
            player.displayClientMessage(
                    Component.translatable("message.bertie_s1.already_licensed"), true);
        ...
        player.displayClientMessage(
                Component.translatable("message.bertie_s1.crafting_licensed"), false);
